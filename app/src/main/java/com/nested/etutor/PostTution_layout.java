...
public class PostTution_layout extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("   Post tuition");

        setContentView(R.layout.activity_post_tution_layout);

        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        nex = findViewById(R.id.nextbuttonid);

        mAdView = findViewById(R.id.tutionpost_adView);
        MobileAds.initialize(this, "ca-app-pub-6092741281885131~8241310035");
        ...
        district = findViewById(R.id.distrctid);
        ...
        if (upazilaN.isEmpty()) {
            ...
            if (isNetworkAvailable()) {
                if (v.getId() == R.id.nextbuttonid) {
                    Intent intent = new Intent(PostTution_layout.this, Teacher_Account.class);
                    intent.putExtra("teacherkey", passvalue);
