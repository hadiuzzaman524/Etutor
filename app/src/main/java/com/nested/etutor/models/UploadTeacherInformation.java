...
public class UploadTeacherInformation {
    private String tname, taddress, teducation, t_class, tsubject, tmobile, tsalary, timagelink, date,userprofile;

    public UploadTeacherInformation() {
    }

    public UploadTeacherInformation(String tname, String taddress, String teducation, String t_class, String tsubject, String tmobile, String tsalary, String timagelink, String date, String userprofile) {
        this.tname = tname;
