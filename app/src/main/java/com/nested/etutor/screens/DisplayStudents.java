...
import com.nested.etutor.Adapter.CustomAdapter;
...
public class DisplayStudents extends AppCompatActivity {
    ...
    List<UploadStudentPostInformation> uploadList;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    UploadStudentPostInformation upload = dataSnapshot1.getValue(UploadStudentPostInformation.class);
