...
public class FindTeacher_layout extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_teacher_layout);
        ...
        district = findViewById(R.id.find_teacher_districtid_);
        upazila = findViewById(R.id.find_teacher_upazilaid_);
        showteacher = findViewById(R.id.showteacherlistid);
        showteacher.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        String passvalue = "teacher" + districtN + upazilaN;
        ...
        if (upazilaN.isEmpty()) {
            ...
            if (isNetworkAvailable()) {
                if (v.getId() == R.id.showteacherlistid) {
                    district.setText("");
                    upazila.setText("");
                    Intent intent = new Intent(FindTeacher_layout.this, DisplayTeachers.class);
                    intent.putExtra("displayteacher", passvalue);
