...
import com.nested.etutor.Adapter.MyAdepter;
...
public class DisplayTeachers extends AppCompatActivity {
    ...
    MyAdepter myAdepter;
    List<UploadTeacherInformation> uploadList;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    UploadTeacherInformation upload = dataSnapshot1.getValue(UploadTeacherInformation.class);
