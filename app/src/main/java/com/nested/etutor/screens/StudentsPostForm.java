...
public class StudentsPostForm extends AppCompatActivity implements View.OnClickListener {
           ...
           /* if (Sdes.isEmpty()) {
            ...
            if (Ssubject.isEmpty()) {
               ...
               /* try {
                ...
                UploadStudentPostInformation upload = new UploadStudentPostInformation(Sname, Saddress, Smobile, Ssalary, Sinstute, S_class, Ssubject, Sdes, currentDate,userProfileInfo);
                String key = databaseReference.push().getKey();
                databaseReference.child(key).setValue(upload);
                ...
                finish();
                Intent intent = new Intent(StudentsPostForm.this, DisplayStudents.class);
                intent.putExtra("displaystudent", jaman);
                startActivity(intent);
                //for ads...
                if (mInterstitialAd.isLoaded()) {
