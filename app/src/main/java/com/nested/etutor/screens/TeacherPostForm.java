...
public class TeacherPostForm extends AppCompatActivity implements View.OnClickListener {
        ...
        if (v.getId() == R.id.teacher_submitid) {
           ...
           /* if (Timagelink.isEmpty()) {
            ...
            if (Tsalary.isEmpty()) {
                ...
                UploadTeacherInformation upload = new UploadTeacherInformation(Tname, Taddress, Teducation, T_class, Tsubject, Tmobile, Tsalary, Timagelink, currentDate,userProfileInfo);
                ...
                finish();
                Intent intent = new Intent(TeacherPostForm.this, DisplayTeachers.class);
