...
import com.nested.etutor.bottomsheets.BottomSheet_Post;
import com.nested.etutor.bottomsheets.Delete_post;
import com.nested.etutor.bottomsheets.EditUserProfileWithBottomSheet;
import com.nested.etutor.bottomsheets.ProfilePhotoChengerBottomSheet;
import com.squareup.picasso.Picasso;

import java.util.HashMap;
import java.util.Map;

public class UserProfile extends AppCompatActivity implements View.OnClickListener, EditUserProfileWithBottomSheet.ButtomEditprofileListener, ProfilePhotoChengerBottomSheet.PhotoChooseListener, Delete_post.DeletepostListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.editprofileid) {
            EditUserProfileWithBottomSheet edit_profile = new EditUserProfileWithBottomSheet();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        ProfilePhotoChengerBottomSheet bottomSheet_post = new ProfilePhotoChengerBottomSheet();
