...
public class FindTuition_layout extends AppCompatActivity implements View.OnClickListener {
   private AutoCompleteTextView district,upazila;
  private   Button showteacher;
   ...
   Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("   Find students");

        setContentView(R.layout.activity_find_tuition_layout);
        ...
        district=findViewById(R.id.find_tu_districtid_);
        upazila=findViewById(R.id.find_tu_upazilaid_);
        showteacher=findViewById(R.id.showstudentlistid);
        button=findViewById(R.id.showstudentlistid);
        button.setOnClickListener(this);

        district_name = getResources().getStringArray(R.array.zilla_name);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, district_name);
    ...
    public void onClick(View v) {
        ...
        String passvalue="student"+districtN+upazilaN;
        ...
        else
        {
            if (isNetworkAvailable()) {
                if (v.getId() == R.id.showstudentlistid) {
                    district.setText("");
                    upazila.setText("");
                    Intent intent = new Intent(FindTuition_layout.this, DisplayStudents.class);
                    intent.putExtra("displaystudent", passvalue);
